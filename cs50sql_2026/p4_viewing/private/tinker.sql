/*
SELECT substr("sentence", 98, 04) FROM sentences WHERE "id" = 14;   -- 14	98	4
SELECT substr("sentence", 03, 05) FROM sentences WHERE "id" = 114;  -- 114	3	5
SELECT substr("sentence", 72, 09) FROM sentences WHERE "id" = 618;  -- 618	72	9
SELECT substr("sentence", 07, 03) FROM sentences WHERE "id" = 630;  -- 630	7	3
SELECT substr("sentence", 12, 05) FROM sentences WHERE "id" = 932;  -- 932	12	5
SELECT substr("sentence", 50, 07) FROM sentences WHERE "id" = 2230; -- 2230	50	7
SELECT substr("sentence", 44, 10) FROM sentences WHERE "id" = 2346; -- 2346	44	10
SELECT substr("sentence", 14, 05) FROM sentences WHERE "id" = 3041; -- 3041	14	5
*/
...
CREATE TEMP VIEW decMessage AS
SELECT "substr" AS "phrase" FROM temp_decode;
SELECT * FROM decMessage;

DROP TABLE temp_decode;
